...
export function setUIState(uiState, options = {}) {
    ...
    if (dom.mainContent) {
        dom.mainContent.classList.toggle('hidden', uiState === 'loading');
    }
...
async function renderHistoryList() {
    ...
    try {
        ...
        // Error is logged and displayed by the firestore function
...
// ... All remaining functions will be in the next response
