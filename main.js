...
import { initializeDOMCache, initializeEventListeners, showNotification } from './ui.js';
...
async function onUserAuthenticated(user) {
    try {
        ...
        // 2. Set the global user ID and update the UI.
        setUserId(user.uid);
        
        // 3. Make all static buttons and elements interactive.
        initializeEventListeners();
        
        // 4. Start the main data loading and rendering process from Firestore.
